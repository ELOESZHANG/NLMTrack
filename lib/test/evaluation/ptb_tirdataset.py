...
class Ptb_TIRDataset(BaseDataset):

    def __init__(self):
        super().__init__()
        self.base_path = self.env_settings.ptb_tir_path
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames_list, 'Ptb_TIR', ground_truth_rect.reshape(-1, 4), object_class=target_class)
