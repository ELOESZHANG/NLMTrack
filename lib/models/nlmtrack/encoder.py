...
from lib.models.nlmtrack import vit as vit_module
from lib.models.nlmtrack import mixformer as transformer_module
...
class Encoder(EncoderBase):
    ...
    def __init__(self, name: str,
        ...
        if "vit" in name.lower():
            encoder = getattr(transformer_module, name)(pretrained=is_main_process(), pretrain_type=pretrain_type,
