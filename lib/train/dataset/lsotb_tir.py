...
class LSOTB_TIR(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None):
        ...
        self.class_list = [f for f in os.listdir(self.root + '/TrainingData')]
        self.class_to_id = {cls_name: cls_id for cls_id, cls_name in enumerate(self.class_list)}
        print(self.image_loader)
    ...
    def _read_bb_anno(self, seq_path):
        ...
        bb_anno_file = os.path.join(self.root, "Annotations",f"{seq_name}")
        xml_path = os.listdir(bb_anno_file)
        gt = []
        for i in range(1, len(xml_path)):
            tree = ElementTree()
    ...
    def _get_sequence_path(self, seq_id):
        ...
        return os.path.join(self.root,"TrainingData" ,f'{seq_name}')
