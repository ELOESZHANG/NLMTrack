...
# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.VAL_EPOCH_INTERVAL = 20   # 验证集间隔
cfg.TRAIN.LR = 0.0001
...
cfg.TRAIN.CE_WEIGHT = 2.0          # 2.0     # 1.0 # weight for cross-entropy loss
cfg.TRAIN.GIOU_WEIGHT = 2.0      # 2.0
cfg.TRAIN.L1_WEIGHT = 0
...
cfg.TEST.PRETRAIN = False

cfg.TEST.UPDATE_INTERVALS = edict()
cfg.TEST.UPDATE_INTERVALS.DEFAULT = 9999
cfg.TEST.UPDATE_INTERVALS.LSOTB_TIR = 25
cfg.TEST.UPDATE_INTERVALS.PTB_TIR = 1
cfg.TEST.UPDATE_INTERVALS.VOT1517 =1     #  2

cfg.TEST.UPDATE_THRESHOLD = edict()
cfg.TEST.UPDATE_THRESHOLD.DEFAULT = 0.6
cfg.TEST.UPDATE_THRESHOLD.LSOTB_TIR = 0.6
cfg.TEST.UPDATE_THRESHOLD.PTB_TIR = 0.47  # 0.475
cfg.TEST.UPDATE_THRESHOLD.VOT1517 = 0.4
